    ...
    return (
        <div className={sideBar ? 'fixed md:hidden top-0 left-0 w-[300px] text-[18px] h-screen z-50 duration-500 shadow-md shadow-black bg-orange-500 text-white' : 'fixed top-0 left-[-100%] w-[50%] h-screen z-50 duration-500 shadow-md shadow-black'}>
            <div className='flex items-center gap-2 p-3'>
                <FaTimes onClick={onClickMenu} className='text-[24px] cursor-pointer text-white' />
                <Link to='/'>
                    <img
                        onClick={() => {
                            window.scroll(0, 0)
                        ...
                        className='max-w-[200px]' src={Logo} alt=""
                    />
                </Link>
            </div>
            <hr />
            ...
            <div className='flex flex-col gap-1 p-4'>
                <Link onClick={onClickMenu} to={'customer/account/orders'}>
                    <p className='flex items-center gap-2'>
                        <FiInbox />
                        Orders
                    </p>
                </Link>
                <Link onClick={onClickMenu} to={'customer/account/saved_items'}>
                    <p className='flex items-center gap-2'>
                        <FaRegHeart />
                        Saved Items
                    </p>
                </Link>
                <Link onClick={onClickMenu} to={'customer/account/wallet'}>
                    <p className='flex items-center gap-2'>
                        <IoWalletOutline />
                        Walllet
                    </p>
